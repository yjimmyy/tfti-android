...
public class Contract {
   ...
   public static abstract class Spots implements BaseColumns {
      ...
      public static final String COLUMN_NAME_FLAG = "flag"; // Update flag

      public static final String CREATE_TABLE = "CREATE TABLE if not exists " + TABLE_NAME + " (" +
         _ID + " INTEGER PRIMARY KEY" + COMMA_SEP +
         COLUMN_NAME_OBJECT_ID + TEXT_TYPE + COMMA_SEP +
         ...
         COLUMN_NAME_FLAG + BOOLEAN_TYPE + " DEFAULT 0" + ");";
   ...
   public static abstract class SpotsUsers implements BaseColumns {
      ...
      //public static final String COLUMN_NAME_LAST_PING = "lastPing";

      public static final String CREATE_TABLE = "CREATE TABLE if not exists " + TABLE_NAME + " (" +
         _ID + " INTEGER PRIMARY KEY," +
         COLUMN_NAME_SPOT_ID + INT_TYPE + COMMA_SEP +
         COLUMN_NAME_USER_ID + INT_TYPE + ");";
         //COLUMN_NAME_LAST_PING + INT_TYPE + ");";
